...
search_index_client = SearchIndexClient(
    service_endpoint, credential, audience=AUDIENCE)

def build_client(index_name: str):
    #TODO: Add error handling for invalid index
    return SearchClient(service_endpoint,
                         index_name, credential, audience=AUDIENCE)
...
async def list_search_indexes() -> list[SearchIndex] | None:
    ...
    return [
        ...
        for i 
        in search_index_client.list_indexes]
